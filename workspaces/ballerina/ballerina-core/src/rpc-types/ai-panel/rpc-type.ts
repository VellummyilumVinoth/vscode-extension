...
export const createTempFileAndGenerateMetadata: RequestType<CreateTempFileRequest, ExtendedDataMapperMetadata> = { method: `${_preFix}/createTempFileAndGenerateMetadata` };
