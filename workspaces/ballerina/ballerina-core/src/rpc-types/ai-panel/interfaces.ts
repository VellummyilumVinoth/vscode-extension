...
import { ExpandedDMModel } from "../../interfaces/inline-data-mapper";

// ==================================
// General Interfaces
// ==================================
export type AIPanelPrompt =
    | { type: 'command-template'; command: Command; templateId: TemplateId; text?: string; params?: Map<string, string>; model?: Map<any, any>; }
