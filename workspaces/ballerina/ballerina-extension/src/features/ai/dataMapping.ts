...
import { Attachment, createFunctionSignature, DataMappingRecord, GenerateMappingFromRecordResponse, GenerateMappingsFromRecordRequest, GenerateTypesFromRecordRequest, GenerateTypesFromRecordResponse, getSource, SyntaxTree } from "@wso2/ballerina-core";
